# Terraform policy hooks

This is the dedicated Terraform policy example.
...
[Pulumi](../policy-opa/README.md) and [OpenTofu](../policy-opa-opentofu/README.md) have separate configurations and fixtures.
...
```bash
bash examples/policy-opa-terraform/check.sh
```
...
| File | Purpose |
| --- | --- |
| [`.reeve/terraform.yaml`](.reeve/terraform.yaml) | `engine.type: terraform`, project/stack declarations, and hook commands. |
